...
public:
	...
	ZBox(ZTvarS inp)
	{
		...
		primt->ApplyModifier(bWidth);
		primt->ApplyModifier(bHeight);
		primt->ApplyModifier(bLength);
		primt->ApplyModifier(bSWidth);
		primt->ApplyModifier(bSHeight);
		primt->ApplyModifier(bSLength);
